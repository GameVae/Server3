...
exports.GetPosition = function getPosition2 (stringKeyCheck,positionCheck){
	var arrayPosition = getPosition (stringKeyCheck,positionCheck)
...
function getPosition (stringKeyCheck,positionCheck) {

	var ID_Unit = stringKeyCheck.split("_")[1]
	var arrayPosition = [];
	
	if (ID_Unit>15&&ID_Unit<20) {
		arrayPosition = unitRange1 (positionCheck);
	}
	if (ID_Unit>20&&ID_Unit<25) {
		arrayPosition = unitRange2 (positionCheck);
	}
	if (ID_Unit>25&&ID_Unit<30) {
		arrayPosition = unitRange1 (positionCheck);
	}
	if (ID_Unit>30&&ID_Unit<35) {
		arrayPosition = unitRange3 (positionCheck);
	}
	return arrayPosition;
}

function unitRange1 (positionCheck) {
...
function unitRange2 (positionCheck) {
...
function unitRange3 (positionCheck) {
	// console.log(row,server_ID)
	var posCenter = positionCheck.toString();
	var posX = parseInt(posCenter.split(",")[0]);
	var posY = parseInt(posCenter.split(",")[1]);
