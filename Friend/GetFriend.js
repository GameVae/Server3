...
function S_UNFRIEND (io,data) {
	...
	// console.log(data)
	var stringQuery ="UPDATE `"+data.ID_User+"` SET `RequestBool`='0',`RemoveTime`="+timeUnfriendData+" WHERE `ID_Player`='"+data.ID_Player+"';"+
...
exports.UpdateDatabase = function updateDatabase2 () {
	updateDatabase ();
}
// updateDatabase ();
