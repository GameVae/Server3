...
var db_database    =   's2_base_info';
var db_debug =   false;
var db_multipleStatements=   true;
var db_charset     =   'utf8_unicode_ci';

var database_s2_base_info   =    mysql.createPool({
...
database_s2_base_info.on('connection', function(connection) {
...
module.exports = database_s2_base_info;
