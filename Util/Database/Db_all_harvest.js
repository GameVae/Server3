...
var db_database          =  'all_harvests';
var db_debug             =  false;
var db_multipleStatements=  true;
var db_charset           =  'utf8_unicode_ci';

var database_all_harvest    =    mysql.createPool({
...
database_all_harvest.on('connection', function(connection) {
...
module.exports = database_all_harvest;