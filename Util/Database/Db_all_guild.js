...
var db_database          =  'all_guilds';
var db_debug             =  false;
var db_multipleStatements=  true;
var db_charset           =  'utf8_unicode_ci';

var database_all_guild    =    mysql.createPool({
...
database_all_guild.on('connection', function(connection) {
...
module.exports = database_all_guild;