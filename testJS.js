...
// var datas = [ '{"ID":420,"ID_Unit":16,"ID_User":44,"BaseNumber":1,"Level":1,"Quality":4,"Hea_cur":5.2,"Health":5.2,"Attack":2.15,"Defend":1.1,"Position_Cell":"301,0,0","Next_Cell":null,"End_Cell":null,"TimeMoveNextCell":null,"TimeFinishMove":null,"ListMove":null,"Attack_Base_ID":null,"Attack_Unit_ID":null,"AttackedBool":0,"Status":6}' ]

// console.log(datas.length)
// test (dataAttack)
var unit = ['1_16_43_376']
// console.log(unit.split("_")[0])
// console.log(unit.split("_")[1])
// console.log(unit.split("_")[2])
// console.log(unit.split("_")[3])
test (1,unit)
function test (Server_ID,dataAttack) {
	var stringHUnit ="s1_unit"
	...
	client.hmget(stringHUnit,dataAttack,function (error,rowsPos) {
		...
		for (var i = 0; i < rowsPos.length; i++) {
			...
			var ID_Unit = dataAttack[i].split("_")[1];
			var ID_User = dataAttack[i].split("_")[2];
			var ID = dataAttack[i].split("_")[3];
